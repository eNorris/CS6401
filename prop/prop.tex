...
Majeed and Ryan \cite{ref:Majeed2006} constructed a context aware GP crossover operator. However, this was for trees only and is very expensive to evaluate, requiring many evaluations for each individual generated to explore contexts.
...
\textbf{what does high density to travel mean?}

% Initialization
\subsubsection{Initialization}
Individuals will be generated at random. \textbf{FINISH THIS SECTION}
...
% New Work
\section{Appendix - Previous Experiments}
